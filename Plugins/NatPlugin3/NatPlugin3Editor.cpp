...
#include "NatPlugin3Editor.h"
#include "NatPlugin3.h"
...
NatPlugin3Editor::NatPlugin3Editor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
...
NatPlugin3Editor::~NatPlugin3Editor()
{

}

void NatPlugin3Editor::startAcquisition()
{
...
void NatPlugin3Editor::stopAcquisition()
{
	plusButton->setEnabled(true);
	for (int i = 0; i < interfaces.size(); i++)
		interfaces[i]->setEnableStatus(true);
}
void NatPlugin3Editor::updateSettings()
{
...
void NatPlugin3Editor::comboBoxChanged(ComboBox* c)
{
...
void NatPlugin3Editor::buttonEvent(Button* button)
{
...
void NatPlugin3Editor::addDetector()
{
    std::cout << "Adding detector" << std::endl;

    NatPlugin3* pd = (NatPlugin3*) getProcessor();
...
void NatPlugin3Editor::saveCustomParameters(XmlElement* xml)
{

    xml->setAttribute("Type", "NatPlugin3Editor");
...
void NatPlugin3Editor::loadCustomParameters(XmlElement* xml)
{
...
DetectorInterface::DetectorInterface(NatPlugin3* pd, Colour c, int id) :
