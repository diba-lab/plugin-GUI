...
#ifndef __NATPLUGIN3_H_F411F29D__
#define __NATPLUGIN3_H_F411F29D__
...
/**
    ...
    @see GenericProcessor, NatPlugin3Editor
*/
class NatPlugin3 : public GenericProcessor
{
public:
    NatPlugin3();
    ~NatPlugin3();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NatPlugin3);
};

#endif  // __NATPLUGIN3_H_F411F29D__
