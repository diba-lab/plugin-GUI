...
NatPlugin3::NatPlugin3()
    : GenericProcessor      ("Nat Plugin3")
    , activeModule          (-1)
    , risingPos             (false)
    , risingNeg             (false)
    , fallingPos            (false)
...
AudioProcessorEditor* NatPlugin3::createEditor()
{
    editor = new NatPlugin3Editor (this, true);
...
void NatPlugin3::setActiveModule (int i)
{
    activeModule = i;
}


void NatPlugin3::setParameter (int parameterIndex, float newValue)
{
...
void NatPlugin3::updateSettings()
{
...
bool NatPlugin3::enable()
{
    return true;
}


void NatPlugin3::handleEvent (const EventChannel* channelInfo, const MidiMessage& event, int sampleNum)
{
...
void NatPlugin3::process (AudioSampleBuffer& buffer)
{
    checkForEvents ();
...
void NatPlugin3::estimateFrequency()
{
}
