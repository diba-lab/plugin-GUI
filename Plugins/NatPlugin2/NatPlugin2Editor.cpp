...
#include "NatPlugin2Editor.h"
#include "NatPlugin2.h"
...
NatPlugin2Editor::NatPlugin2Editor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
...
NatPlugin2Editor::~NatPlugin2Editor()
{

}

void NatPlugin2Editor::startAcquisition()
{
...
void NatPlugin2Editor::stopAcquisition()
{
	plusButton->setEnabled(true);
	for (int i = 0; i < interfaces.size(); i++)
		interfaces[i]->setEnableStatus(true);
}
void NatPlugin2Editor::updateSettings()
{
...
void NatPlugin2Editor::comboBoxChanged(ComboBox* c)
{
...
void NatPlugin2Editor::buttonEvent(Button* button)
{
...
void NatPlugin2Editor::addDetector()
{
    std::cout << "Adding detector" << std::endl;

    NatPlugin2* pd = (NatPlugin2*) getProcessor();
...
void NatPlugin2Editor::saveCustomParameters(XmlElement* xml)
{

    xml->setAttribute("Type", "NatPlugin2Editor");
...
void NatPlugin2Editor::loadCustomParameters(XmlElement* xml)
{
...
DetectorInterface::DetectorInterface(NatPlugin2* pd, Colour c, int id) :
