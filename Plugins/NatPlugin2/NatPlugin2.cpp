...
NatPlugin2::NatPlugin2()
    : GenericProcessor      ("Nat Plugin2")
    , activeModule          (-1)
    , risingPos             (false)
    , risingNeg             (false)
    , fallingPos            (false)
...
AudioProcessorEditor* NatPlugin2::createEditor()
{
    editor = new NatPlugin2Editor (this, true);
...
void NatPlugin2::setActiveModule (int i)
{
    activeModule = i;
}


void NatPlugin2::setParameter (int parameterIndex, float newValue)
{
...
void NatPlugin2::updateSettings()
{
...
bool NatPlugin2::enable()
{
    return true;
}


void NatPlugin2::handleEvent (const EventChannel* channelInfo, const MidiMessage& event, int sampleNum)
{
...
void NatPlugin2::process (AudioSampleBuffer& buffer)
{
    checkForEvents ();
...
void NatPlugin2::estimateFrequency()
{
}
